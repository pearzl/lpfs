...
impl FromStr for BlockTypeNumber {
    ...
    fn from_str(s: &str) -> Result<BlockTypeNumber, crate::ProcErr> {
        ...
        Ok(BlockTypeNumber { node, zone, counts })
    }
}
        ...
        let correct = PageTypeInfo {
            ...
            free_pages: vec![
                (
                    0,
                    String::from("DMA"),
                    String::from("Unmovable"),
                    [2, 10, 13, 8, 4, 1, 2, 2, 0, 0, 0],
                ),
                (
                    0,
                    String::from("DMA"),
                    String::from("Reclaimable"),
                    [3, 1, 2, 2, 1, 0, 1, 1, 1, 0, 0],
                ),
                (
                    0,
                    String::from("DMA"),
                    String::from("Movable"),
                    [2, 1, 1, 0, 1, 1, 0, 1, 2, 0, 0],
                ),
                (
                    0,
                    String::from("DMA"),
                ...
                (
                    ...
                    String::from("DMA32"),
                    String::from("Unmovable"),
                    [148, 77, 109, 136, 20, 7, 0, 0, 0, 0, 0],
                ),
                (
                    0,
                    String::from("DMA32"),
                    String::from("Reclaimable"),
                    [31, 135, 247, 159, 31, 11, 3, 0, 0, 0, 0],
                ),
                (
                    0,
                    String::from("DMA32"),
                    String::from("Movable"),
                    [452, 198, 246, 1628, 565, 17, 18, 16, 11, 1, 0],
                ),
                (
                    0,
                    String::from("DMA32"),
