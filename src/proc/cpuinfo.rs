...
impl FromStr for Processor {
    ...
    fn from_str(s: &str) -> Result<Processor, crate::ProcErr> {
        ...
        let address_sizes = {
            ...
            (columns[0].parse::<u8>()?, columns[3].parse::<u8>()?)
        };

        let power_management = map
    ...
    fn si0_p0() -> Processor {
        Processor {
            ...
            flags: vec![
                ...
                String::from("movbe"),
                String::from("popcnt"),
                String::from("tsc_deadline_timer"),
                String::from("aes"),
                String::from("xsave"),
                String::from("osxsave"),
                String::from("avx"),
                ...
                String::from("lahf_lm"),
                String::from("abm"),
                String::from("3dnowprefetch"),
                String::from("fsgsbase"),
                String::from("tsc_adjust"),
                String::from("bmi1"),
                String::from("hle"),
                String::from("avx2"),
                String::from("smep"),
                ...
                String::from("adx"),
                String::from("smap"),
                String::from("clflushopt"),
                String::from("intel_pt"),
                String::from("ibrs"),
                String::from("ibpb"),
                String::from("stibp"),
                String::from("ssbd"),
