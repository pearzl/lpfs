...
pub fn fd_of(pid: Pid) -> Result<Vec<Fd>, crate::ProcErr> {
...
pub fn fd_of_task(pid: Pid, tid: Tid) -> Result<Vec<Fd>, crate::ProcErr> {
    fd_impl!{format!("/proc/{}/task/{}/fd", pid, tid)}
}

pub fn fd_self_task(tid: Tid) -> Result<Vec<Fd>, crate::ProcErr> {
